...
class GO:
    ...
    def valid_place_check(self, i, j, piece_type, test_check=True):
        '''
    ...
    def play(self, player1, player2, verbose=False):
        ...
        while 1:
            ...
            if self.game_end(piece_type):       
                ...
                # if player1.type == 'my':
                #     player1.learn(self, piece_type!=1, piece_type)
                # elif player2.type == 'my':
                #     player2.learn(self, piece_type!=2, piece_type)
                if verbose:
                    print('Game ended.')
                    if result == 0: 
